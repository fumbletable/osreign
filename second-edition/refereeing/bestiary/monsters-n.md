...
**Neanderthal** (HD 2) | XP 40
AC 11 | HP 8 | Mv Normal | Ml 7
Atk club (d8) or spear (d6)
Primitive humans. Stronger than average (+1 damage). Live in caves, hunt in packs. Not stupid - just different.
...
**Nixie** (HD 1/2) | XP 5
AC 12 | HP 2 | Mv Normal, Swim Fast | Ml 6
Atk small sword (d4)
1 in 10 can cast powerful Charm Person (CHA 8 with SETBACK). Charmed victims walk into the water to serve for a year. Dispel Magic: 75% on land, 25% in water.
Capricious water fey. Ordinarily friendly, but utterly unpredictable.
