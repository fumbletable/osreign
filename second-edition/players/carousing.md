...
**Why carousing?** It solves two problems:

1. **Gold accumulation.** Without spending, treasure piles up meaninglessly. Carousing gives it somewhere to go.

2. **Uneven party advancement.** If a Fighter carouses while the Magic-User saves for spell research, the Fighter levels faster—but becomes a better bodyguard for the squishy wizard. Everyone benefits.

**The mishap table creates stories.** The most common result (7) is just a hangover. But the extremes—jail, enemies, windfalls—become campaign moments.

**Limits by settlement size.** You can only spend what the local economy can absorb. A village tavern can't handle 2,000 gp of revelry. This also encourages returning to larger towns.
