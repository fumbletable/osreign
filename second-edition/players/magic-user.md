...
**HD:** 4 + CON, then 1d4 (avg 2) + CON per level
**Saves:** INT, WIS
**Ability Boost:** +1 INT
**Weapons:** Light
**Armor:** None
...
Alternatively, you may spend a **Boost Die** to **extend a spell's duration one step** where sensible (Referee adjudicates).

---

## Spellbook

You begin with a spellbook containing *Read Magic* plus **(1 + INT modifier)** 1st-tier spells.
...
- **Scholar:** Dagger, Arcane Staff, Spellbook.
- **Apprentice-on-the-Road:** Dagger, Spellbook, Arcane Focus, Chalk & charcoal.
