...
Protection costs mobility - pick your trade-off.

---

## Armor List

| Armor | Cost | AC | Tags | Min STR | Don/Doff |
|:------|-----:|:---|:-----|--------:|:---------|
| None | – | 10 + DEX | – | – | – |
| Leather | 20 gp | 12 + DEX | Light | – | 1 min |
| Chain | 60 gp | 14 + DEX (max 2) | Medium | 9 | 5 min / 1 min |
| Plate | 300 gp | 18 | Heavy, Bulky | 12 | 10 min / 5 min |
| Shield | 7 gp | +1 | Sunder | – | 1 action |

---

## Armor Tags

**Proficiency tiers** - your class grants proficiency with Light, Medium, and/or Heavy armor.
