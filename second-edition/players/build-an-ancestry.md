...
Each core ancestry also has **one Essential trait** - a non-negotiable ability that defines them in old-school play.

---

## Mystara Examples

These examples use the Build-an-Ancestry rules to show how you might create other ancestries in a Mystara-inspired setting.
