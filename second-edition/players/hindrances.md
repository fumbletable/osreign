...
|   2 | Arrogant            | SETBACK on first-impression CHA checks; WIS (12) to swallow an insult.                    |
...
|   5 | Freeze Up           | On first combat round, act last unless you pass WIS (12).                                 |
...
|  11 | Compulsive Gambler  | If downtime passes without betting, lose 1 Provision (squandered in games).               |
|  12 | Unworldly           | SETBACK on CHA checks in urban/noble settings (you seem rustic/strange).                  |
|  13 | Nightmares          | Begin each day with 1 Fatigue unless you pass WIS (12).                                   |
|  14 | Craven              | At 0 HP, drop prone and beg unless you pass WIS (12).                                     |
|  15 | Dark Secret         | If revealed, suffer SETBACK on reactions in that community until repaired.                |
|  16 | Weak Stomach        | WIS save (12) or vomit in gore/foul stench zones.                                         |
...
|  20 | Old War Wound       | At combat start: CON save (12) or gain 1 Fatigue.                                         |
...
|  23 | Proud               | Must answer insults; WIS (12) to resist dueling/escalating.                               |
...
|  30 | Hot-Headed          | Always react aggressively to insults; WIS (12) to avoid escalating.                       |
...
|  36 | Stubborn            | Cannot back down; WIS save (12) to retreat.                                               |
|  37 | Wanted              | Pursued by law or bounty hunters.                                                         |
|  38 | Gullible            | WIS save (12) to resist obvious scams/lies.                                               |
|  39 | Fear of Magic       | WIS save (12) to avoid panic when witnessing spells.                                      |
|  40 | Fear of Beasts      | WIS save (12) to avoid panic near monstrous animals.                                      |
|  41 | Fear of Undead      | WIS save (12) to avoid panic when undead appear.                                          |
...
|  44 | Fear of Water       | WIS save (12) to enter deep water; SETBACK on Swim checks.                                |
|  45 | Fear of Heights     | WIS save (12) near cliffs or ledges; SETBACK on climbing.                                 |
